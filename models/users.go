...
var UserWhere = struct {
	...
	RealmID: whereHelpernull_Int{field: "\"users\".\"realm_id\""},
}
...
var (
	userAllColumns            = []string{"id", "realm_id"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "realm_id"}
...
func (o *User) Realm(mods ...qm.QueryMod) realmQuery {
...
func (userL) LoadRealm(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// SetRealmG of the user to the related item.
// Sets o.R.Realm to related.
// Adds o to related.R.Users.
// Uses the global database handle.
func (o *User) SetRealmG(ctx context.Context, insert bool, related *Realm) error {
	return o.SetRealm(ctx, boil.GetContextDB(), insert, related)
}

// SetRealmP of the user to the related item.
// Sets o.R.Realm to related.
// Adds o to related.R.Users.
// Panics on error.
func (o *User) SetRealmP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Realm) {
	if err := o.SetRealm(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetRealmGP of the user to the related item.
// Sets o.R.Realm to related.
// Adds o to related.R.Users.
// Uses the global database handle and panics on error.
func (o *User) SetRealmGP(ctx context.Context, insert bool, related *Realm) {
	if err := o.SetRealm(ctx, boil.GetContextDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetRealm of the user to the related item.
// Sets o.R.Realm to related.
// Adds o to related.R.Users.
func (o *User) SetRealm(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Realm) error {
	var err error
	if insert {
...
// Uses the global database handle.
func (o *User) RemoveRealmG(ctx context.Context, related *Realm) error {
...
// Removes o from all passed in related items' relationships struct.
// Panics on error.
func (o *User) RemoveRealmP(ctx context.Context, exec boil.ContextExecutor, related *Realm) {
...
// Removes o from all passed in related items' relationships struct.
// Uses the global database handle and panics on error.
func (o *User) RemoveRealmGP(ctx context.Context, related *Realm) {
...
// Sets o.R.Realm to nil.
// Removes o from all passed in related items' relationships struct.
func (o *User) RemoveRealm(ctx context.Context, exec boil.ContextExecutor, related *Realm) error {
	var err error
...
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddPostsGP(ctx context.Context, insert bool, related ...*Post) {
...
// Sets o.R.User's Posts accordingly.
// Replaces o.R.Posts with related.
// Sets related.R.User's Posts accordingly.
// Uses the global database handle.
func (o *User) SetPostsG(ctx context.Context, insert bool, related ...*Post) error {
...
// Sets related.R.User's Posts accordingly.
// Panics on error.
func (o *User) SetPostsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Post) {
...
// Sets related.R.User's Posts accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetPostsGP(ctx context.Context, insert bool, related ...*Post) {
...
func (o *User) SetPosts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Post) error {
	query := "update \"posts\" set \"user_id\" = null where \"user_id\" = $1"
...
// Sets related.R.User.
// Uses the global database handle.
func (o *User) RemovePostsG(ctx context.Context, related ...*Post) error {
...
// Sets related.R.User.
// Panics on error.
func (o *User) RemovePostsP(ctx context.Context, exec boil.ContextExecutor, related ...*Post) {
...
// Sets related.R.User.
// Uses the global database handle and panics on error.
func (o *User) RemovePostsGP(ctx context.Context, related ...*Post) {
